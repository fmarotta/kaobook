...
\Option{two-} or \Option{one- side} options, but there must be a way to 
fix this strange behaviour using only \Package{floatrow}. If you know 
...
caption above the table by just issuing the \Command{caption} command 
