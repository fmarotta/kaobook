...
\verb|glossaries|.\sidenote[*-1.5][]{If you don't want all these things 
in the table of contents, pass the appropriate KOMA options to the 
class.}
...
twoside mode, left vs right in oneside mode)\sidenote[*-1.5][]{As of 
