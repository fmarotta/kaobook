%\setchapterpreamble[o]{
	...
	%\includegraphics[width=\paperwidth,height=7cm,keepaspectratio=false]{images/seaside}
%}
% beforeskip=-(figure_height-top_margin)
%\RedeclareSectionCommand[beforeskip=-4.40cm]{chapter}
...
\begin{description}
	...
	\item[Margin text] We provide commands \verb|\sidenote| and 
		...
		margins\sidenote[*-1][]{Sidenotes (like this!) are numbered 
