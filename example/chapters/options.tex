...
the \verb|toc| option of the package \verb|glossaries|.\sidenote{If you 
don't want all these things in the table of contents, pass the 
appropriate KOMA options to the class.}
