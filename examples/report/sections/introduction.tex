...
years ago, \sidecite[-1\baselineskip]{Lander2001a,Venter2001c} one of 
...
\sidecite[-1\baselineskip+2pt]{Gamazon2015a} dubbed Transcriptome-Wide 
...
region (\vreffig{response}). This amount is different in different 
...
\sidecite[-19\baselineskip-2.5mm+1pt]{Nagpal2019} here we will focus only on 
...
Due to its nature, DNA lends itself to a representation where the 
...
ones (\reffig{predictorsB}). Indeed, all the published works on this 
...
gene $A$ in individual $i$ can be modeled as in \vrefeq{expr}, 
