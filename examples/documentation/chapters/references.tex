...
\Package{kaobiblio} also supports one option that is not shared with
\Package{biblatex}: \Option{addspace}. If you pass this option when
loading \Package{kaobiblio}, a space will be automatically added before
the citation marks.
